...
export default function Home() {
  ...
  return (
    <main id="top" className="flex flex-col items-center gap-14 w-full min-h-screen overflow-x-hidden bg-white">
      ...
      <div className="relative flex flex-row w-full h-58 bg-yellow-200 px-15 items-center justify-between shrink-0">
        ...
        <Image 
          ...
          width={254} 
          height={317} 
          className="absolute right-15 -bottom-20 z-0 pointer-events-none" 
        />
      </div>

      <div className="flex flex-col mt-6 w-full min-h-150 gap-5 mb-15">
        ...
        <section key={index} className="flex flex-col gap-4">
          ...
          <div className="flex justify-between items-end px-20">
            ...
            <button className="text-sm text-gray-400 font-medium underline hover:text-gray-600 transition">
                See All
            </button>
          </div>

          <div className="flex ml-16 gap-6 overflow-x-auto pb-6 px-4 no-scrollbar snap-x snap-mandatory scroll-smooth">
            
            {section.items.map((item) => (
              <div key={item.id} className="shrink-0 snap-center first:pl-2 last:pr-2">
                ...
                <EventCard 
                  ...
                  onViewDetail={() => {
                    ...
                    setSelectedColor(getThemeColor(section.theme));
                  }}
                />
              </div>
            ))}
