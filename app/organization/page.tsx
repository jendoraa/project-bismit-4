...
export default function Latest() {
  ...
  return (
    <main className="flex flex-col items-start gap-14 bg-white relative">
      ...
      {/* Header Khusus Organization (TETAP SAMA: Biru & Teks Hitam) */}
      <div className="flex flex-row w-full h-58 bg-blue-400 pl-10 pr-15 items-center justify-between">
        ...
        <h2 className="flex font-extrabold text-4xl gap-3 font-Inter shrink-0">
          <span className="text-black -ml-20">Organization</span>
        </h2>
        <SearchBar />
      </div>
      ...
      <div className="w-full min-h-150 pl-10 pr-20 mt-10 mb-20">
        {visibleSections.map((section, index) => {
            ...
            const customTextColor = "text-black"; // Tetap Hitam sesuai desain Organization
